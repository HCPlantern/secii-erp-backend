...
@Repository
@Mapper
public interface PurchaseReturnsSheetDao extends Dao {
    /**
     * 获取最近一条进货退货单
     *
     * @return 最近一条进货退货单
     ...
     * @return 影响的条目数
     */
    int updateState(String purchaseReturnsSheetId, BaseEnum state);
     ...
     * @return 影响的条目数
     */
    int updateStateV2(String purchaseReturnsSheetId, BaseEnum prevState, BaseEnum state);
